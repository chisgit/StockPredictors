...
def display_market_status(last_available_date=None):
    ...
    def update_selected_tickers(change):
        """Update the selected tickers based on the multiselect widget."""
    ...
    def add_new_ticker(new_ticker):
        """Add a new ticker to the list if it's valid and not already present."""
    ...
    def render_ticker_multiselect():
        """Render the multiselect widget for selecting stock tickers."""
    ...
    def render_new_ticker_input():
        """Render the text input for adding a new stock ticker."""
    ...
    def render_predict_button():
        """Render the predict button and handle its action."""
    ...
    def render_ui():
        ...
        render_ticker_multiselect()
        render_new_ticker_input()
